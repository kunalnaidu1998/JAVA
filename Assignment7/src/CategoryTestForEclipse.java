...
public class CategoryTestForEclipse extends FormatTester{
	...
	private void testClassDefinition()
	{
		...
		assertTrue("Class should have abstract methods calculateGrades that returns a double (minimize whitespace in signature).", hasRequiredAbstractMethods(abstractMethods));
